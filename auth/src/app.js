...
class App {
  ...
  setRoutes() {
    this.app.post("/api/v1/login", (req, res) => this.authController.login(req, res));
    this.app.post("/api/v1/register", (req, res) => this.authController.register(req, res));
    this.app.get("/api/v1/dashboard", authMiddleware, this.authController.getProfile);
  }
